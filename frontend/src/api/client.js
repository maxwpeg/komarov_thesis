...
export const projectsApi = {
  list(filters = {}) {
    return apiRequest(appendQueryParams('/api/projects', filters));
  },
  listTrash(filters = {}) {
    return apiRequest(appendQueryParams('/api/projects/trash', filters));
  },
  get(projectId) {
  ...
  listPdfVersions(projectId) {
    return apiRequest(`/api/projects/${projectId}/pdf-versions`);
  },
...
export const backgroundTasksApi = {
  ...
  retry(taskId) {
    return apiRequest(`/api/background-tasks/${taskId}/retry`, {
      method: 'POST',
    });
  },
};
...
export const auditApi = {
  list(filters = {}) {
    return apiRequest(appendQueryParams('/api/audit', filters));
  },
  exportUrl(filters = {}) {
    return buildApiUrl(appendQueryParams('/api/audit/export', filters));
  },
};
