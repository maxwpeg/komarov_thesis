...
def add_program_text(doc: Document):
    ...
    add_paragraph(
        doc,
        "На верхнем уровне репозитория выделены каталоги backend, floorplan-ui, floorplan, "
    ...
    add_bullet(doc, "floorplan-ui – клиентское приложение React, реализующее интерфейс проектировщика.")
    ...
    add_paragraph(
        doc,
        "Клиентская часть расположена в каталоге floorplan-ui и реализована на React 19. "
        "Файл floorplan-ui/src/App.jsx задает маршруты приложения и связывает страницы "
    ...
    add_paragraph(
        doc,
        "Доступ к серверному API централизован в файле floorplan-ui/src/api/client.js. "
    ...
    add_paragraph(
        ...
        "из каталога floorplan-ui стандартными средствами React Scripts. При таком сценарии "
