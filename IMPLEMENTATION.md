...
A complete full-stack web application for floor plan management with fire alarm system design capabilities and comprehensive PDF generation.

## Latest Update: PDF Generation System ✨

### Новая функциональность генерации PDF

Реализована комплексная система автоматической генерации проектной документации в формате PDF с полной структурой документа.

**Ключевые возможности:**
- ✅ Автоматическая структура документа (12+ типов страниц)
- ✅ Категоризация планов этажей по системам (ЗКСПС, СПС, СОУЭ)
- ✅ Центрирование чертежей относительно рамок
- ✅ Автоматическая конвертация изображений в градации серого
- ✅ Поддержка разных форматов страниц (A3, A4, горизонтальные/вертикальные)
- ✅ Титульные листы с подписями и без
- ✅ Автоматическая нумерация страниц

**Измененные файлы:**
1. [Project.py](Project.py) - добавлены методы генерации полной структуры документа
2. [backend/pdf_generator.py](backend/pdf_generator.py) - упрощенная интеграция с новой логикой
3. [test_pdf_generation.py](test_pdf_generation.py) - тестовый скрипт (создан)
4. [PDF_GENERATION_GUIDE.md](PDF_GENERATION_GUIDE.md) - подробное руководство (создан)
5. [README.md](README.md) - обновлена документация

**Структура генерируемого PDF:**
1. Титульный лист (без подписи)
2. Титульный лист (с подписями)
3. Страница A3 горизонтальная
4. Страница A4 вертикальная
5. Страница A4 вертикальная (рамка типа 2)
6. 2 страницы A4 вертикальных
7. Чертежи ЗКСПС (каждый на A3 горизонтальном)
8. Чертежи СПС (каждый на A3 горизонтальном)
9. Чертежи СОУЭ (каждый на A3 горизонтальном)
10. Схемы подключения (A3 горизонтальная) - TODO
11. Спецификация (A3 горизонтальная) - TODO
12. Расчет токопотребления (A4 вертикальная) - TODO

**Документация:**
- См. [PDF_GENERATION_GUIDE.md](PDF_GENERATION_GUIDE.md) для подробной информации
